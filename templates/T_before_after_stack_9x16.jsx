/* Template before-after-stack-9x16 — Before + After Stacked 9:16 */
(function () {
  ...
  window.TEMPLATES.push({
    id: "before-after-stack-9x16",
    name: "Before + After Stacked 9:16",
    width: 1080,
    height: 1920,
    slots: 2,
    desc: "Both clips visible at once: Before on top, After below. Use each slot's “Freeze after” setting to stop one clip at a chosen second (it holds its frame) while the other keeps playing.",
    Component
  });
})();
