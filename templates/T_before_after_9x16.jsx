/* Template before-after-9x16 — Before / After 9:16 */
(function () {
    ...
    return (
      <div className="relative overflow-hidden bg-black" style={{ width: 1080, height: 1920 }}>
        ...
        <div className="absolute inset-0">
          ...
          {Tag({ swap: "label1", text: "Before → After" })}
        </div>
      </div>
    );
  }
  ...
  window.TEMPLATES.push({
    id: "before-after-9x16",
    name: "Before / After 9:16",
    width: 1080,
    height: 1920,
    slots: 1,
    desc: "One full-bleed vertical stage for sequential clips: open the slot's Sequence and add two videos with their time windows (e.g. Before 0–5s, After 5–10s) — they play back-to-back in the preview and the export.",
    Component
  });
})();
